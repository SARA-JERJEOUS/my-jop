...
namespace Dal.Migrations
{
    ...
    partial class data_collectionModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dal.newdata.disease", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.disease_drug", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.drug", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.role", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.sideDrug", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.sideeffect", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.sym_disease", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.symptomes", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.user", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dal.newdata.disease_drug", b =>
                {
                    b.HasOne("Dal.newdata.disease", "diseases")
                        .WithMany("disease_drugs")
                        .HasForeignKey("diseaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dal.newdata.drug", "drugs")
                        .WithMany("disease_drugs")
            ...
            modelBuilder.Entity("Dal.newdata.sideDrug", b =>
                {
                    ...
                    b.HasOne("Dal.newdata.sideeffect", "sideeffects")
                        .WithMany("sideDrugs")
            ...
            modelBuilder.Entity("Dal.newdata.sym_disease", b =>
                {
                    ...
                    b.HasOne("Dal.newdata.symptomes", "symptom")
                        .WithMany("symp_disease")
            ...
            modelBuilder.Entity("Dal.newdata.user", b =>
                {
                    b.HasOne("Dal.newdata.role", "roles")
                        .WithMany("users")
